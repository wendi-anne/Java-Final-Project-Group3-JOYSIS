...
public class layoutTest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 450, 990));
        ...
        jPanel3.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -30, 1480, 940));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 80, 1480, 990));
...
//        if (x == 450) {
//	    jPanel2.setSize(450, 990);
//	    Thread menuTh = new Thread() {
//		@Override
//		public void run() {
//		    try {
//		    for (int i = 450; i >= 0; i==) {
//			Thread.sleep(1);
//			jPanel2.setSize(i, 990);
//		    }
//		    catch (Exception e) {
